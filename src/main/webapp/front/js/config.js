...
var centerMenu = [
    ...
    ,{
        name: '图纸收藏',
        url: '../tuzhiCollection/list.jsp'
    }
    ,{
        name: '图纸订单',
        url: '../tuzhiOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '图纸信息',
        url: './pages/tuzhi/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/jianzhuzhuangxiutuzhi/index.jsp";
