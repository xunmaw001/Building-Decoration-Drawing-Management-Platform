	...
	<body style="background: #EEEEEE;">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shiguongfangName" id="shiguongfangName" lay-verify="required" placeholder="施工方姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shiguongfangIdNumber" id="shiguongfangIdNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shiguongfangPhone" id="shiguongfangPhone"  lay-verify="required|phone"   placeholder="手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="shiguongfangPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="shiguongfangPhoto" name="shiguongfangPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`shiguongfang/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#shiguongfangPhotoImg").attr("src", data.data.shiguongfangPhoto);
                });
