            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">施工方展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shiguongfangName" id="shiguongfangName" placeholder="施工方姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shiguongfangContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shiguongfangContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#shiguongfangName').val() != null && jquery('#shiguongfangName').val() != "" && jquery('#shiguongfangName').val() != "null" ) {
                param['shiguongfangName'] = jquery('#shiguongfangName').val();
            }
                                                    // 获取列表数据
            http.request('shiguongfang/list', 'get', param, function(res) {
