            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">设计师展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shejishiName" id="shejishiName" placeholder="设计师姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shejishiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shejishiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#shejishiName').val() != null && jquery('#shejishiName').val() != "" && jquery('#shejishiName').val() != "null" ) {
                param['shejishiName'] = jquery('#shejishiName').val();
            }
                                                    // 获取列表数据
            http.request('shejishi/list', 'get', param, function(res) {
