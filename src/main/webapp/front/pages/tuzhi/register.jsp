              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">图纸标题:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="tuzhiName" id="tuzhiName"  placeholder="图纸标题"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="tuzhiTypes" id="tuzhiTypes" lay-filter="tuzhiTypes" style="width: 600px;">
