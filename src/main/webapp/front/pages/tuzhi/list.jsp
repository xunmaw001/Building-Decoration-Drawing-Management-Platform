            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">图纸信息展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../tuzhi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../tuzhi/detail.jsp?id='+item.id)"><span>{{item.tuzhiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 tuzhiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            tuzhiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (tuzhiTypes != null && tuzhiTypes != "" && tuzhiTypes != "null") {
                param['tuzhiTypes'] = tuzhiTypes;
                                            ...
                                            // 获取列表数据
            http.request('tuzhi/list', 'get', param, function(res) {
