            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">用户交流登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="tuzhiName" name="tuzhiName" class="form-control"
                                                   v-model="ruleForm.tuzhiName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>图纸预览</label>
                                        <img id="tuzhiPhotoImg" width="100" height="100">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>类型</label>
                                        <input id="tuzhiValue" name="tuzhiValue" class="form-control"
                                               v-model="ruleForm.tuzhiValue" readonly>
                                    </div>


                                        <div class="form-group col-md-6">
                                            <label>发布设计师</label>
                                            <input id="shejishiId" name="shejishiId" class="form-control"
                                                   v-model="ruleForm.shejishiId" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="tuzhiId" name="tuzhiId" v-model="ruleForm.tuzhiId" readonly type="hidden">
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "tuzhiLiuyan/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.tuzhiContent != null && ruleForm.tuzhiContent != 'null' && ruleForm.tuzhiContent != '') {
            var tuzhiContentUeditor = UE.getEditor('tuzhiContentEditor');
                tuzhiContentUeditor.ready(function () {
                    ...
                    tuzhiContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.tuzhiLiuyanContent != null && ruleForm.tuzhiLiuyanContent != 'null' && ruleForm.tuzhiLiuyanContent != '') {
            var tuzhiLiuyanContentUeditor = UE.getEditor('tuzhiLiuyanContentEditor');
                tuzhiLiuyanContentUeditor.ready(function () {
                    var mes = '' + ruleForm.tuzhiLiuyanContent;
