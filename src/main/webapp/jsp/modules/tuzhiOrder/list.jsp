        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">图纸订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">图纸订单管理</li>
                            <li class="breadcrumb-item active">图纸订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">图纸订单列表</h3>
    ...
    <script>
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("tuzhiOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        // 删除
        function jiedan(id) {
            var mymessage = confirm("真的要接这个订单吗？");
            if (mymessage == true) {
                http("tuzhiOrder/jiedan?ids="+id, "get", {}, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('操作成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addtuzhiOrder", "addtuzhiOrder");
            window.location.href = "add-or-update.jsp"
        }
