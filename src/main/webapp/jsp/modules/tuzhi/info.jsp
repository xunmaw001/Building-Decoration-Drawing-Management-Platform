            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">图纸信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shejishiName" name="shejishiName" class="form-control"
                                                   v-model="ruleForm.shejishiName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shejishiIdNumber" name="shejishiIdNumber" class="form-control"
                                                   v-model="ruleForm.shejishiIdNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shejishiPhone" name="shejishiPhone" class="form-control"
                                                   v-model="ruleForm.shejishiPhone" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>照片</label>
                                        <img id="shejishiPhotoImg" width="100" height="100">
                                    </div>
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shejishiId" name="shejishiId" v-model="ruleForm.shejishiId" readonly type="hidden">
...
<script>
    ...
    function setDownloadBtn() {
        var tuzhiFileUrl = "download('" + ruleForm.tuzhiFile + "')";
        $("#tuzhiFile").attr("onclick", tuzhiFileUrl);
