...
public class TuzhiLiuyanView extends TuzhiLiuyanEntity implements Serializable {
	...
	public TuzhiLiuyanView() {

	}

	public TuzhiLiuyanView(TuzhiLiuyanEntity tuzhiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, tuzhiLiuyanEntity);
