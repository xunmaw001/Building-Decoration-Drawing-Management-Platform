...
public class TuzhiOrderView extends TuzhiOrderEntity implements Serializable {
	...
	public TuzhiOrderView() {

	}

	public TuzhiOrderView(TuzhiOrderEntity tuzhiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, tuzhiOrderEntity);
